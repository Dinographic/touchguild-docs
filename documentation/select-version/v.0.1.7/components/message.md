...
| \_client              | the client that receives the channel data                                                                           | <mark style="color:purple;"></mark>[Client](../../v.0.1.6/components/client.md)                 |
...
| mentions              | Message mentions object                                                                                             | Object ([<mark style="color:purple;">MentionsType</mark>](../../v.0.1.6/types/mentionstype.md)) |
...
| channel               | Channel component where the message has been sent on                                                                | [Channel](../../v.0.1.6/components/channel.md)                                                  |
...
| params.oldMessage?        | old message component, if cached.                   | [Message](../../v.0.1.6/components/message.md) | false     |
